...
3. An optional object of configurations accepting the following properties:
    ...
    - `allowUnregistered` (default: false): A boolean indicating if unregistered users should be allowed access. This can be useful for cases where users who aren’t fully registered yet can still access certain routes or resources.
