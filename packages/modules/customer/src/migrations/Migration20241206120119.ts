...
export class Migration20241206120119 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('alter table if exists "customer_group_customer" drop column if exists "created_by";');
  ...
  async down(): Promise<void> {
    ...
    this.addSql('alter table if exists "customer_group_customer" add column if not exists "created_by" text null;');
