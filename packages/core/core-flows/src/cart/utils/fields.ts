...
export const completeCartFields = [
  ...
  "payment_collection.payments.currency_code",
  "payment_collection.payments.captures.id",
  "payment_collection.payments.captures.raw_amount",
  "payment_collection.payments.captures.amount",
  "items.variant.id",
